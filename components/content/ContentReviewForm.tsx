...
interface ContentReviewFormProps {
  ...
  existingReview?: ContentReview;
  onSubmit: (review: Partial<ContentReview>) => Promise<void>;
  onCancel?: () => void;
}

const ContentReviewForm: React.FC<ContentReviewFormProps> = ({
  contentPostId,
  existingReview,
  onSubmit,
  onCancel,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const reviewData: Partial<ContentReview> = {
        contentPostId,
        userId: user.uid,
