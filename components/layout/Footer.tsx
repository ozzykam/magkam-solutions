        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">Local Market</span>
            </div>
            <p className="text-sm text-gray-400 mb-4">
              Fresh, local products delivered to your door. Supporting local farmers and businesses.
            </p>
            {/* Social Media Links */}
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/shop" className="text-sm hover:text-primary-500 transition-colors">
                  All Products
                </Link>
              </li>
              <li>
                <Link href="/deals" className="text-sm hover:text-primary-500 transition-colors">
                  Deals & Sales
                </Link>
              </li>
              <li>
                <Link href="/new-arrivals" className="text-sm hover:text-primary-500 transition-colors">
                  New Arrivals
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/careers" className="text-sm hover:text-primary-500 transition-colors">
                  Careers
                </Link>
              </li>
              <li>
