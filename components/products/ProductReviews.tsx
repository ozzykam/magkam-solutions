...
import { createReview, checkVerifiedPurchase, markReviewHelpful, getProductReviews } from '@/services/review-service';
...
export default function ProductReviews({
  ...
  const handleSubmitReview = async (reviewData: Partial<Review>) => {
    try {
      ...
      const isVerified = await checkVerifiedPurchase(user.uid, productId);
      ...
      // Refresh product to get updated rating stats
      const updatedProduct = await getProductBySlug(productSlug);
