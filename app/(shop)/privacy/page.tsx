      ...
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-4">
            ...
            <li><strong>Leave reviews:</strong> Product ratings and comments</li>
          </ul>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-4">
            <li>Send promotional emails about new products, sales, and special offers (you can opt out)</li>
        ...
        <section className="mb-8">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-4">4.2 Local Vendors and Farmers</h3>
          <p className="text-gray-700 mb-4">
            We may share limited order information (product, quantity, delivery timeframe) with our partner vendors
            and farmers to fulfill your orders. They are prohibited from using your personal information for any
            other purpose.
          </p>
