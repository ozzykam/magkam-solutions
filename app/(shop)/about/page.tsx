...
export default function AboutPage() {
  const values = [
    ...
    },
    {
      ...
      description: 'Every product is carefully selected to ensure you receive the freshest, highest-quality goods.',
    },
    {
      icon: TruckIcon,
      title: 'Fresh & Fast',
  ...
  const stats = [
    ...
    { label: 'Deliveries Per Week', value: '1,000+' },
  ];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-6">
                Connecting Communities Through Fresh, Local Food
              </h1>
              <p className="text-xl md:text-2xl text-primary-100 max-w-3xl mx-auto">
                We&apos;re more than just a marketplace – we&apos;re a bridge between local farmers,
                artisans, and neighbors who believe in quality, sustainability, and community.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-b from-gray-50 to-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Getting fresh, local products delivered to your door is simple
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Explore products from local vendors. Filter by tags, vendors, or search for exactly what you need.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Receive your order and enjoy the freshest products from your community. Support local, eat well.
                </p>
              </div>
            </div>
          </div>
